  ...
  return (
    <>
      ...
      <p ref={paragraphRef} className="mt-4 text-secondary text-[17px] max-w-3xl leading-[30px]">
        ...
        like Php, Laravel, codeigniter, wordpress, Vue js, React js, Node js, and next js. I'm a quick learner and collaborate closely with clients to create efficient, 
